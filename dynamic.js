        ...
        table.innerHTML += `
            ...
            <tr>
              ...
              <i onclick="removeFromCart('${
                cartBooks[0]
              }')" style = "width:50px;height:40px;border-radius:0" class="fas fa-trash-alt"></i>
            </tr>`;
      });
...
function updateBook() {
  ...
  fetch(
    "https://peaceful-mountain-01759.herokuapp.com/edit-book/" +
      info["isbn"] +
      "/",
    {
      method: "PUT",
...
function deleteBook() {
  ...
  console.log(id);
  fetch("https://peaceful-mountain-01759.herokuapp.com/delete-post/" + id + "/")
    .then((res) => res.json())
